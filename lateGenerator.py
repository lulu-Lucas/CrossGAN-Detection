    ...
    def __init__(self, scope_name):
        ...
        with tf.variable_scope(self.scope):
            with tf.variable_scope('encoder'):
                ...
                self.weight_vars.append(self._create_variables(64, 16, 3, scope = 'dense_block_conv4'))
        self.weight_vars2 = []
        with tf.variable_scope(self.scope):
            with tf.variable_scope('encoder'):
                ...
                self.weight_vars2.append(self._create_variables(32, 16, 3, scope='conv2_3'))
                self.weight_vars2.append(self._create_variables(48, 16, 3, scope='conv2_4'))
                self.weight_vars2.append(self._create_variables(64, 16, 3, scope='conv2_5'))
        self.weight_vars3 = []
        with tf.variable_scope(self.scope):
            with tf.variable_scope('encoder'):
                ...
                self.weight_vars3.append(self._create_variables(32, 16, 3, scope='conv3_3'))
                self.weight_vars3.append(self._create_variables(48, 16, 3, scope='conv3_4'))
                self.weight_vars3.append(self._create_variables(64, 16, 3, scope='conv3_5'))
    ...
    def encode(self, image1,image2,image3):
        ...
        for i in range(len(self.weight_vars)):
            ...
            if i in dense_indices:
                ...
                out2 = conv2d(out2, kernel2, bias2, dense=True, use_relu=True,
                             Scope=self.scope + '/encoder/b2' + str(i))
                out3 = conv2d(out3, kernel3, bias3, dense=True, use_relu=True,
