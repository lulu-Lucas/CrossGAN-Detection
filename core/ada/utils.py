...
def image_preporcess(image1, image2,image3,image4,image5,target_sizex,target_sizey, gt_boxes=None):
    ...
    image_paded2 = np.full(shape=[ih, iw, 1], fill_value=0.5)
    image_paded3 = np.full(shape=[ih, iw, 1], fill_value=0.5)
    ...
    if gt_boxes is None:
        return image_paded1,image_paded2,image_paded3,image_paded4,image_paded5
    #
    # else:
    ...
    #     return image_paded1,image_paded2,image_paded3, gt_boxes
        ...
        gt_boxes[:, [0, 2]] = gt_boxes[:, [0, 2]] * scale + dw
        gt_boxes[:, [1, 3]] = gt_boxes[:, [1, 3]] * scale + dh
        return image_paded1, image_paded2, image_paded3,image_paded4,image_paded5, gt_boxes
